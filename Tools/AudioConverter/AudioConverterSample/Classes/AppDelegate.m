...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _typeConverterVc = [[TypeConverterViewController alloc] init];
    _navBarController = [[UINavigationController alloc] initWithRootViewController:_typeConverterVc];
